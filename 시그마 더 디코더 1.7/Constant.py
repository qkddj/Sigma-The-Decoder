...
Settings_window_frame_variable2 = 1
...
class interface: 
    ...
    def itembar(itembar_coordinate, skill_available):
...
class Block:
    def __init__(self,pos = (0,0),wide = 100, value = 0,fill_color = (255,255,255),line_color = (0,0,0),surface = screen):
        self.value = value
        self.pos = pos
        self.txt = ScreenTxt(str(self.value),self.pos[0],self.pos[1])
    ...
    def show(self):
        pygame.draw.rect(self.surface,self.fill_color,(self.pos[0]-int(self.wide/2),self.pos[1]-int(self.wide/2),self.wide,self.wide))
        pygame.draw.rect(self.surface,self.line_color,(self.pos[0]-int(self.wide/2),self.pos[1]-int(self.wide/2),self.wide,self.wide),5)
        self.txt.show()
...
class ScriptCircum:
    def __init__(self,cont1 = "",cont2= "Thou art more lovely and more temperate.",cont3="",is_typing = True,per_time = 0.03):
        ...
        self.txt1 = ScreenTxt("",pos_y=740,size = 50,txt_color=DarkGray)
        self.txt2 = ScreenTxt("",pos_y=825,size = 50,txt_color=DarkGray)
        self.txt3 = ScreenTxt("",pos_y=920,size = 50,txt_color=DarkGray)
    ...
    def show(self):
        if self.is_typing:
            for i in self.cont1:
                ...
                pygame.draw.rect(screen,PowderBlue,(100,680,1720,300))
                pygame.draw.rect(screen,Black,(100,680,1720,300),5)
...
#script when talking
class ScriptTalk:
    def __init__(self,standing = "img\lara staindg.webp",name = "Lara",cont1 = "Shall i compare thee to a summer's day?",cont2= "Thou art more lovely and more temperate.",cont3="Rough winds do shake the darling buds of May",is_typing = True,per_time = 0.03):
        # img size : 320 * 275
        self.standing = ScreenImg(standing,300,830)
        self.name = ScreenTxt(name,520,712,size= 50, pos_central= False)
        ...
        self.txt1 = ScreenTxt("",520,795,size = 40,pos_central= False)
        self.txt2 = ScreenTxt("",520,850,size = 40,pos_central= False)
        self.txt3 = ScreenTxt("",520,905,size = 40,pos_central= False)
    ...
    def show(self):
        ...
        if self.is_typing:
            for i in self.cont1:
                ...
                pygame.draw.rect(screen,PowderBlue,(100,680,1720,300))
                pygame.draw.rect(screen,Black,(100,680,1720,300),5)
                pygame.draw.rect(screen,Black,(500,760,self.name.object.get_size()[0] + 50,5))
...
def field_array(n):
    ...
    random_array = numpy.random.choice(range(1, 20 + 1), size, replace= True)
